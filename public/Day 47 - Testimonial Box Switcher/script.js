...
const testimonialText = document.getElementsByClassName("testimonial-text")[0];
const testimonialImage =
    document.getElementsByClassName("testimonial-image")[0];
const testimonialName = document.getElementsByClassName("testimonial-name")[0];
const testimonialPosition = document.getElementsByClassName(
...
function setNewTestimonial(data) {
    testimonialText.innerHTML = data.text;
    testimonialName.innerHTML = data.name;
    testimonialPosition.innerHTML = data.position;

    testimonialImage.style.backgroundImage = `url(${data.photo})`;
}
